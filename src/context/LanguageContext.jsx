  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          id: 'agricure',
          name: 'AgriCure — Plant Disease Detection',
    ...
    now: {
      ...
      items: [
        ...
        {
          id: 'agricure',
          name: 'AgriCure — Saudi Agriculture',
          status: 'In Progress',
          started: '2026',
    ...
    aime: {
      ...
      tour: [
        ...
        { text: 'AgriCure — plant-disease detection running at 73 ms on a Raspberry Pi. He led the four-person team behind it.', action: 'projects.agricure' },
        { text: "And Aime — that's me: Whisper, Claude, and ElevenLabs, deployed and talking to you right now.", action: 'projects.aime' },
        { text: "What he's building now: hardening Board Room and AgriCure into trustworthy, Arabic-first systems for the Saudi market.", action: 'now' },
  ...
  ar: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          id: 'agricure',
          name: 'أجريكيور — كشف أمراض النباتات',
    ...
    now: {
      ...
      items: [
        ...
        {
          id: 'agricure',
          name: 'أجريكيور — للزراعة السعودية',
          status: 'قيد التطوير',
          started: '2026',
    ...
    aime: {
      ...
      tour: [
        ...
        { text: 'أجريكيور — كشف أمراض النباتات بزمن 73 مللي ثانية على Raspberry Pi، وقد قاد فريقه المكوّن من أربعة مهندسين.', action: 'projects.agricure' },
        { text: 'وآيم — هذا أنا: Whisper وClaude وElevenLabs، منشور ويتحدث معك الآن.', action: 'projects.aime' },
        { text: 'ما يبنيه الآن: تطوير مجلس الإدارة وأجريكيور إلى أنظمة موثوقة تتحدث العربية أولاً للسوق السعودي.', action: 'now' },
